    ...
    <div className="text-[var(--white)] max-w-5xl mx-auto px-4">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-5">
              {driveId && (
                <button
                  ...
                  className="btn bg-[var(--dark96)] py-2 px-5 text-sm sm:text-base"
                >
              ...
              {trailer && (
                <button
                  ...
                  className="btn py-2 px-5 text-sm sm:text-base"
                >
                  <img src="/play-icon.svg" className="w-4 h-4" alt="Play" />{" "}
                  TRAILER
                </button>
      ...
      {driveId && (
        <iframe
          ...
          className="w-full aspect-video mt-12 sm:mt-16 md:mt-20 bg-gray-800 border border-white/10"
          allowFullScreen
        />
      )}
